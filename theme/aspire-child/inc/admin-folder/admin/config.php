...
<!--Code used to display Theme Information Tab-->
		...
		$this->sections[] = array (
			...
			'fields' => array (
                ...
                //     'id' => 'footer_para',
                //     'type' => 'textarea',
                //     'title' => __('Footer paragraph', 'kraftives'),
                //     'rows'    => '4'
                // ),
                array(
                    'id'       => 'login-logo',
                ...
                //     'type'     => 'media',
                //     'url'      => true,
                //     'title'    => __( 'Header Banner', 'redux-framework-demo' ),
                // ),
		...
		/* Footer Banner Data END */
		 ...
		 $this->sections[] = array (
			...
			'fields' => array (
                ...
                //     'id' => 'contact2',
                //     'type' => 'text',
                //     'title' => __('Contact Phone Second', 'kraftives'),
                // ),
                array (
                    'id' => 'location',
                    'type' => 'text',
                    'title' => __('Contact Location', 'kraftives'),
                    'validate' => 'location',
                ),
				array (
                    'id' => 'Contacturl',
                    'type' => 'text',
                    'title' => __('Contact Url', 'kraftives'),
                    'validate' => 'Contacturl',
                ),
				array (
                    'id' => 'email',
                ...
                //     'id' => 'email2',
                //     'type' => 'text',
                //     'title' => __('Contact Email Second', 'kraftives'),
                //     'validate' => 'email',
                // ),
                // array (
                //     'id' => 'address',
				...
				// 	'id' => 'phone',
				// 	'type' => 'text',
				// 	'title' => __('Contact Page Sidebar', 'kraftives'),
    //                 'label'    => true,
    //                 'options'  => array(
    //                     'c1_name' => 'Title',
    //                 ),
    //             ),
                ...
                //     'id' => 'f-para',
                //     'type' => 'textarea',
                //     'title' => __('First paragraph', 'kraftives'),
                //     'rows'    => '2'
                // ),
                ...
                //     'id' => 's-para',
                //     'type' => 'textarea',
                //     'title' => __('Second paragraph', 'kraftives'),
                //     'rows'    => '2'
                // ),
    //             array (
				// 	'id' => 'contact_form',
    ...
    //                 )
         ...
         $this->sections[] = array (
            'title' => __('Connect With Us', 'kraftives'),
            'fields' => array (
                array (
                    'id' => 'connect_para',
                    'type' => 'text',
                    'title' => __('Description', 'kraftives')              
                ),
				array (
                    'id' => 'connect_form',
                    'type' => 'text',
                    'title' => __('Subscribe Shortcode', 'kraftives')              
                )
